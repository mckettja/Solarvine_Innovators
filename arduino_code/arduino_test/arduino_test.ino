...
//Bluetooth Code
  ...
  // WiFi AP SSID
  #define WIFI_SSID  "1819_Guest" //"MySpectrumWiFi10-2G" //"1819_Guest" //"Anthony's iPhone" //"UC_Secure" //"iPhone" //"TeneComp"
  // WiFi password
  #define WIFI_PASSWORD "NULL" //"longsquirrel956" //"NULL" //"EKkJ-Txsy-3LNB-NqiN" //"Priv0naut~" //"tzrkh9gzw16ku" //"~!IWantOut!~"
  
  #define INFLUXDB_URL "https://us-east-1-1.aws.cloud2.influxdata.com"
  #define INFLUXDB_TOKEN "RH4oxqeypqwS9rXDO7L-S7ieWjGwdrEEMaRfOm2eGyULrNQGObRllxvM2SczQ81Y8N2H0glkbRdYuka_90dPdg=="
  #define INFLUXDB_ORG "65831f5e68f42d85"
  #define INFLUXDB_BUCKET "testing_bucket"
